...
echo ""
echo -e "                 \033[1;31mBy @cerberus_ghost\033[1;36m"
echo ""
...
sleep 5
cd /bin || exit
wget https://github.com/cerberus9116/check/blob/ntech/gestorssh/chuser > /dev/null 2>&1
wget https://github.com/cerberus9116/check/blob/ntech/gestorssh/userscheck > /dev/null 2>&1
...
wget https://github.com/cerberus9116/check/blob/ntech/gestorssh/checkuser.py > /dev/null 2>&1
...
echo ""
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@cerberus_ghost\033[0m"
